...
const COMPUTED_GROUPS: { group: string; members?: MemberSource; why?: string }[] = [
    ...
    { group: 'AddMeetingForm.kindOptions.', members: { prismaEnum: 'MeetingKind' } },
    ...
    { group: 'about.proof.items.', why: 'const array in the component' },
    { group: 'about.hero.audiences.', members: { file: 'src/components/about/config.ts', type: 'HeroAudienceId' } },
    { group: 'about.residents.features.', members: { file: 'src/components/about/config.ts', type: 'ResidentFeatureId' } },
    { group: 'about.services.features.', members: { file: 'src/components/about/config.ts', type: 'ServiceFeatureId' } },
    { group: 'about.process.steps.', members: { file: 'src/components/about/config.ts', type: 'ProcessStepId' } },
    { group: 'about.pilot.points.', members: { file: 'src/components/about/config.ts', type: 'PilotPointId' } },
    {
        group: 'about.hero.pilot.',
        why: 'keyed by realm, but only the pending realms have a pilot line: greece is active and never renders it',
    },
    {
        group: 'about.pilot.title.',
        why: 'keyed by realm, but only the pending realms have a pilot band: greece is active and never renders it',
    },
