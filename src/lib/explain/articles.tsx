        ...
        <>
            ...
            <ul>
                ...
                <li>
                    ...
                    θέματα κρίνονται κατεπείγοντα. Ο νόμος τις λέει κατεπείγουσες· οι δήμοι στις προσκλήσεις τους,
                    και το OpenCouncil στο όνομα της συνεδρίασης, τις λένε «Έκτακτες».
                </li>
                <li>
