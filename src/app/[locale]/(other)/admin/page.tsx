...
import { Users, FileText, Settings, Search, ClipboardCheck, Landmark, Link as LinkIcon } from 'lucide-react';
    ...
    return (
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Link href="/admin/related-subjects">
                    <Card className="hover:shadow-md transition-shadow cursor-pointer">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Related Subjects</CardTitle>
                            <LinkIcon className="h-4 w-4 text-muted-foreground" />
                        </CardHeader>
                        <CardContent>
                            <p className="text-xs text-muted-foreground">
                                Debug the hybrid related-subjects search output
                            </p>
                        </CardContent>
                    </Card>
                </Link>
