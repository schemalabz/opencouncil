...
import {
  ...
  SubjectPills,
} from "@/components/og/shared-components";
...
const ConsultationOGImage = async (cityId: string, consultationId: string) => {
  ...
  const consultationData = await getConsultationDataForOG(
    cityId,
    consultationId,
  );
  ...
  const chaptersCount =
    regulationData?.regulation?.filter((item) => item.type === "chapter")
      .length || 0;
  const geosetsCount =
    regulationData?.regulation?.filter((item) => item.type === "geoset")
      .length || 0;
                ...
                .map((chapter, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {chapter.title?.substring(0, 40) || "Άτιτλο Κεφάλαιο"}
                      {chapter.title && chapter.title.length > 40 ? "..." : ""}
                    </span>
                  </div>
                ))}
            </div>
  ...
  return (
    <Container>
      ...
      >
        ...
        >
          Χρησιμοποιούμε τεχνητή νοημοσύνη για να παρακολουθούμε τα δημοτικά
          συμβούλια και να τα κάνουμε απλά και κατανοητά
        </div>
  ...
  return (
    <Container>
      ...
      >
        ...
        >
          Βρείτε αναφορές σε θέματα, τοποθετήσεις συμβούλων και στατιστικά από
          όλα τα δημοτικά συμβούλια
        </div>
  ...
  return (
    <Container>
      ...
      >
        ...
        >
          Συνομιλήστε με την τεχνητή νοημοσύνη για να μάθετε για δημοτικά
          συμβούλια και θέματα πολιτικής
        </div>
...
export async function GET(request: Request) {
  ...
  try {
    ...
    if (consultationId && cityId) {
      ...
      return await SubjectOgImage({
        params: { locale: "el", cityId, meetingId, subjectId },
      });
