...
export async function PUT(request: Request, { params }: { params: { cityId: string } }) {
    ...
    try {
        ...
        // Message data (not in schema, handled separately)
        ...
        const updateData: CityUpdateData = {
            ...
            ...(data.name_municipality && { name_municipality: data.name_municipality }),
            ...(data.name_municipality_en && { name_municipality_en: data.name_municipality_en }),
            ...(data.timezone && { timezone: data.timezone }),
            ...(logoImageUrl && { logoImage: logoImageUrl }),
            ...(data.authorityType && { authorityType: data.authorityType }),
            ...
            ...(data.peopleOrdering && { peopleOrdering: data.peopleOrdering }),
            ...(data.highlightCreationPermission && { highlightCreationPermission: data.highlightCreationPermission }),
        }
