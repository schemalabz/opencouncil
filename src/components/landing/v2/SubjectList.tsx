...
/**
 * The scrollable subject list, shared by desktop panel and mobile sheet. Infinite-scroll paging,
 * scrolls the selected card into view, loading/empty states. `variant` switches container chrome;
 * `footer` renders inside the scroll area after the cards (e.g. FewResultsHint).
 */
export function SubjectList({
    ...
    // Scroll the selected card into view. `subjects` dep so a deep-linked selection scrolls in
    // once its card appears.
    useEffect(() => {
