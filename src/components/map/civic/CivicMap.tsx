...
import { FLY_TO_DURATION_MS, FLY_TO_MIN_ZOOM, MAP_DEFAULT_CENTER, MAP_DEFAULT_ZOOM, MAP_MAX_ZOOM } from '@/lib/map/constants';
...
import { SUBJECTS_HALO_LAYER_ID } from './subjectsLayer';
...
import { useMapInteractions, type CivicMapCallbacks } from './useMapInteractions';
import { type CivicMapHandle, type CivicMapPadding, type CivicMapProps } from './types';
...
function CivicMapInner(props: CivicMapProps) {
    ...
    const callbacksRef = useRef<CivicMapCallbacks>({
    ...
    // Subjects on the map + their interactions: the clustered subjects layer,
    // donut marker pool, spiderfier, selection highlight + fly-to, panel hover,
    // and the unified click resolver.
    useMapInteractions(map, isLoaded, {
        interactive,
        reducedMotion,
        subjects: props.subjects,
        selectedSubjectId: props.selectedSubjectId,
        hoveredSubjectId: props.hoveredSubjectId,
        flyToSelected: props.flyToSelected,
        markerOptions: props.markerOptions,
        clusterAriaLabel: props.labels?.clusterAria,
