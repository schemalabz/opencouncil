...
import { ExternalLink, Trash2, FileCheck, FileX, RefreshCw, Loader2, Bot, UserIcon, Plus, X, ChevronDown } from 'lucide-react';
...
export function DecisionsPanel({ open, onOpenChange }: DecisionsPanelProps) {
    ...
    const unlinkedSubjectIds = unlinkedSubjects.map(s => s.id);
    const canPoll = !!city.diavgeiaUid;
                        ...
                        {canPoll ? (
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="outline" size="sm" disabled={isPolling}>
                                        {isPolling ? (
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    {t('decisions.pollDisabledNoConfig')}
                                </TooltipContent>
                            </Tooltip>
                        )}
                    </div>
