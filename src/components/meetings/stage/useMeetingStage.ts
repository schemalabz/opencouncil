...
import { publicMeetingStage, reviewDeadline, stageSignalsFromMeetingData, type PublicMeetingStage } from '@/lib/meetingStage';
...
/**
 * The meeting page's stage, re-read once a minute so an upcoming meeting turns
 * live — and the live one starts waiting — without a reload.
 */
