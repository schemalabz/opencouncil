...
export function Statistics() {
    ...
    return (
        <div className="flex flex-col items-center">
            <h3 className="text-lg font-medium">Θέματα που συζητήθηκαν</h3>
            <ul className="mb-8">
                {sortedTopics.map((topicStat, index) => (
                    <TopicBadge topic={topicStat.topic} count={topicStat.count} key={topicStat.topic.id} />
                ))}
            </ul>

            <h3 className="text-lg font-medium">Χρόνοι ομιλίας ανά παράταξη</h3>
            <p className="text-gray-500 mb-4">{meeting.name}</p>
            ...
            <h3 className="text-lg font-medium">Χρόνοι ομιλίας ανά ομιλητή</h3>
