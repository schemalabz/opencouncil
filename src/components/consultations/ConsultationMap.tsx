...
import { RegulationData, ReferenceFormat, Geometry, CurrentUser, ConsultationMapProps, GeoSetData, DerivedGeometry, BufferOperation, StaticGeometry, RegulationItem } from "@/lib/consultations/types";
