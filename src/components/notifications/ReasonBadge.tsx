...
export function ReasonBadge({ reason }: { reason: string }) {
    const badges = {
        proximity: {
            ...
            explanation: 'Αυτό το θέμα επιλέχθηκε επειδή βρίσκεται κοντά σε μία από τις τοποθεσίες που έχετε επιλέξει στις προτιμήσεις ενημερώσεών σας.'
        },
        topic: {
            label: 'Θεματική',
            variant: 'secondary' as const,
            explanation: 'Αυτό το θέμα επιλέχθηκε επειδή αφορά μία από τις θεματικές κατηγορίες που έχετε επιλέξει στις προτιμήσεις ενημερώσεών σας.'
        },
        generalInterest: {
