...
import type { StoryTemplateId } from "@/components/og/story-template-meta";
...
export type { StoryTemplateId } from "@/components/og/story-template-meta";
export { STORY_TEMPLATES, isValidStoryTemplate } from "@/components/og/story-template-meta";
