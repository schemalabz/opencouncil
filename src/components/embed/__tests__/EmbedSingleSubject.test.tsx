...
const subject: PublicSubject = {
    ...
    councilMeeting: { id: 'old_2020', cityId: 'city', name: 'Συνεδρίαση', name_en: 'Meeting', kind: null, dateTime: new Date('2020-04-06T10:00:00Z'), administrativeBody: null, taskStatuses: [], city: { id: 'city', name: 'Αθήνα', name_en: 'Athens', timezone: 'Europe/Athens', realm: 'greece', logoImage: null } },
};
