    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[6px] bg-[hsl(var(--orange-deep))] text-sm font-medium text-white transition-opacity hover:opacity-85 sm:w-auto sm:px-4"
            >
