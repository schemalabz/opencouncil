...
TABLES=("City" "Party" "Person" "CouncilMeeting" "SpeakerTag" "SpeakerSegment" "Utterance" "Word" "Topic" "TopicLabel" "Summary" "Subject" "SubjectSpeakerSegment" "Highlight" "HighlightedUtterance" "PodcastSpec" "PodcastPart" "PodcastPartAudioUtterance" "Location" "Offer" "Waitlist")
