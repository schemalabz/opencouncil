...
-- View 3: Subject with stripped markdown references for description
...
WHERE schemaname = 'public'
  AND viewname IN ('LocationSearchView', 'IntroducedByPartyView', 'SubjectSearchView', 'SpeakerContributionSearchView');
\echo ''
...
-- Check 4: Verify subjects can join with introduced_by party data
\echo '4. Checking Subject → IntroducedByPartyView joins...'
SELECT 
...
-- Check 5: SubjectSearchView - verify description stripping works
\echo '5. Checking SubjectSearchView data...'
SELECT 
