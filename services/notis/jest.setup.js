...
delete process.env.BIRD_WHATSAPP_TEMPLATE_DEMOS_TRANSITION;
delete process.env.BIRD_WHATSAPP_TEMPLATE_DEMOS_INTRO;
delete process.env.BIRD_WHATSAPP_TEMPLATE_DEMOS_UPDATE_AGENDA;
delete process.env.BIRD_WHATSAPP_TEMPLATE_DEMOS_UPDATE_NEWS;
delete process.env.BIRD_WHATSAPP_TEMPLATE_DEMOS_FOLLOWUP;
