...
import { CURRENT_PERIOD } from "../_lib/chart-colors";
...
const TONES = {
  orange: { stroke: CURRENT_PERIOD, fillFrom: CURRENT_PERIOD },
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={points} margin={{ top: 2, right: 0, left: 0, bottom: 0 }}>
            ...
            {/* Never a bare `dataMax`: a series of zeroes collapses the
                domain to [0,0], which d3 maps to the MIDDLE of the range,
                and a flat zero would draw halfway up the card. */}
